...
import math
from models.positional import RotaryPositionEmbedding
...
class MultiHeadAttention(nn.Module):
    def __init__(self, d_model: int, num_heads: int, use_rope: bool = False, max_seq_len: int = 5000):
        super().__init__()
...
class GroupedQueryAttention(nn.Module):
    def __init__(self, d_model: int, num_q_heads: int, num_kv_heads: int, use_rope: bool = False, max_seq_len: int = 5000):
        super().__init__()
